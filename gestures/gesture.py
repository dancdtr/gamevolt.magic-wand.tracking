...
class Gesture:
    ...
    def __str__(self) -> str:
        """Return a dense, one-line JSON snapshot suitable for later analysis."""
        ...
        # net direction (note: your W/E, S/N sign convention preserved)
        ...
        # (cap length to avoid runaway logs; adjust if you want full fidelity)
        MAX_POINTS = 256
        ...
        payload = {
            ...
            # direction (from your precomputed average)
            ...
            # velocity totals in your coordinate semantics
            "totals": {
            ...
            # per-point series (trimmed if very long)
            "series_v": {
                "cols": ["t_ms", "vx", "vy"],
                "trimmed": trimmed,
                "rows": series,
        ...
        # Emit compact JSON (stable key order helps diffing)
