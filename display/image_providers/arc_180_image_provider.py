...
class Arc180ImageProvider(ImageProvider):
    def __init__(self, base_png: str, image_size: int) -> None:
        ...
        self._image_library: dict[GestureType, PhotoImage] = {
            GestureType.ARC_180_CW_START_N: self.create(base_image, image_size),
            ...
            GestureType.ARC_180_CCW_START_N: self.create(base_image, image_size, flip_x=True),
            GestureType.ARC_180_CCW_START_E: self.create(base_image, image_size, rotation_angle=90, flip_x=True),
            GestureType.ARC_180_CCW_START_S: self.create(base_image, image_size, flip_y=True),
            GestureType.ARC_180_CCW_START_W: self.create(base_image, image_size, rotation_angle=270, flip_x=True),
        }
