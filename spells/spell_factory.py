...
_SPELLS = [
    ...
    Spell(
        is_implemented=True, id="SP18", type=SpellType.APARECIUM, definition=[G.LINE_W, G.LINE_N, G.LINE_S, G.LINE_N, G.LINE_S, G.LINE_N]
    ),
    ...
    Spell(is_implemented=True, id="SP21", type=SpellType.CANTIS, definition=[G.ARC_270_CCW_START_N, G.LINE_ESE]),
    ...
    Spell(is_implemented=True, id="SP25", type=SpellType.HORN_TONGUE, definition=[G.LINE_SE, G.LINE_NE, G.LINE_SSW]),
