...
def has_bounce_n2s(g: Gesture) -> bool:
    return is_bounce(g, Azimuth.N, Azimuth.S)

def has_bounce_e2w(g: Gesture) -> bool:
    return is_bounce(g, Azimuth.E, Azimuth.W)

def has_bounce_s2n(g: Gesture) -> bool:
    return is_bounce(g, Azimuth.S, Azimuth.N)

def has_bounce_w2e(g: Gesture) -> bool:
    return is_bounce(g, Azimuth.W, Azimuth.E)

def is_bounce(g: Gesture, towards: Azimuth, backwards: Azimuth) -> bool:
        match towards, backwards:
            ...
            case _: raise ValueError(f"No oscillation defined for {towards.name} / {backwards.name}.")
