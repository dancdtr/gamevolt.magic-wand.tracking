...
def is_direction_n(direction: Vector2) -> bool:
    return _is_azimuth(direction, Azimuth.N)


def is_direction_e(direction: Vector2) -> bool:
    return _is_azimuth(direction, Azimuth.E)


def is_direction_s(direction: Vector2) -> bool:
    return _is_azimuth(direction, Azimuth.S)


def is_direction_w(direction: Vector2) -> bool:
    return _is_azimuth(direction, Azimuth.W)
...
def is_direction_ne(direction: Vector2) -> bool:
    return _is_azimuth(direction, Azimuth.NE)


def is_direction_se(direction: Vector2) -> bool:
    return _is_azimuth(direction, Azimuth.SE)


def is_direction_sw(direction: Vector2) -> bool:
    return _is_azimuth(direction, Azimuth.SW)


def is_direction_nw(direction: Vector2) -> bool:
    return _is_azimuth(direction, Azimuth.NW)
...
def is_direction_nne(direction: Vector2) -> bool:
    return _is_azimuth(direction, Azimuth.NNE)


def is_direction_ene(direction: Vector2) -> bool:
    return _is_azimuth(direction, Azimuth.ENE)


def is_direction_ese(direction: Vector2) -> bool:
    return _is_azimuth(direction, Azimuth.ESE)


def is_direction_sse(direction: Vector2) -> bool:
    return _is_azimuth(direction, Azimuth.SSE)


def is_direction_ssw(direction: Vector2) -> bool:
    return _is_azimuth(direction, Azimuth.SSW)


def is_direction_wsw(direction: Vector2) -> bool:
    return _is_azimuth(direction, Azimuth.WSW)


def is_direction_wnw(direction: Vector2) -> bool:
    return _is_azimuth(direction, Azimuth.WNW)


def is_direction_nnw(direction: Vector2) -> bool:
    return _is_azimuth(direction, Azimuth.NNW)


# =========================================
# Utils
# =========================================
def _is_azimuth(direction: Vector2, azimuth: Azimuth, variance_deg: float = 22.5) -> bool:
