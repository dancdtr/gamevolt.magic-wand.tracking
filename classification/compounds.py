from classification.arcs import is_arc_180_cw_start_n, is_arc_270_cw_start_w
...
def is_p(g: Gesture) -> bool:
    ...
    part1 = has_azimuth_n(g1)
    part2a = is_arc_270_cw_start_w(g2)
    part2b = is_arc_180_cw_start_n(g2)
