...
def has_curve_180_cw_start_n(g: Gesture) -> bool:
    return ends_with_x_turn_type_e2w(g) and is_moving_s(g)


def has_curve_180_cw_start_e(g: Gesture) -> bool:
    return ends_with_y_turn_type_s2n(g) and is_moving_w(g)


def has_curve_180_cw_start_s(g: Gesture) -> bool:
    return ends_with_x_turn_type_w2e(g) and is_moving_n(g)


def has_curve_180_cw_start_w(g: Gesture) -> bool:
    return ends_with_y_turn_type_n2s(g) and is_moving_e(g)
...
def has_curve_180_ccw_start_n(g: Gesture) -> bool:
    return ends_with_x_turn_type_w2e(g) and is_moving_s(g)


def has_curve_180_ccw_start_e(g: Gesture) -> bool:
    return ends_with_y_turn_type_n2s(g) and is_moving_w(g)


def has_curve_180_ccw_start_s(g: Gesture) -> bool:
    return ends_with_x_turn_type_e2w(g) and is_moving_n(g)


def has_curve_180_ccw_start_w(g: Gesture) -> bool:
    return ends_with_y_turn_type_s2n(g) and is_moving_e(g)
...
# Arcs 450 CW
# =========================================
def is_arc_450_cw_start_n(g: Gesture) -> bool:
    return _is_arc_450_cw(g, start=Azimuth.N)


def is_arc_450_cw_start_e(g: Gesture) -> bool:
    return _is_arc_450_cw(g, start=Azimuth.E)


def is_arc_450_cw_start_s(g: Gesture) -> bool:
    return _is_arc_450_cw(g, start=Azimuth.S)


def is_arc_450_cw_start_w(g: Gesture) -> bool:
    return _is_arc_450_cw(g, start=Azimuth.W)


# =========================================
# Arcs 450 CCW
# =========================================
def is_arc_450_ccw_start_n(g: Gesture) -> bool:
    return _is_arc_450_ccw(g, start=Azimuth.N)


def is_arc_450_ccw_start_e(g: Gesture) -> bool:
    return _is_arc_450_ccw(g, start=Azimuth.E)


def is_arc_450_ccw_start_s(g: Gesture) -> bool:
    return _is_arc_450_ccw(g, start=Azimuth.S)


def is_arc_450_ccw_start_w(g: Gesture) -> bool:
    return _is_arc_450_ccw(g, start=Azimuth.W)
...
def _is_arc_450_cw(g: Gesture, start: Azimuth) -> bool:
    return _is_arc_450(g, start, direction=TurnDirection.CW)


def _is_arc_450_ccw(g: Gesture, start: Azimuth) -> bool:
