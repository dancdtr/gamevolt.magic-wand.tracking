...
class WandColourRegistry:
    ...
    def try_get_active(self, wand_id: str) -> str | None:
        return self._active_by_id.get(wand_id.upper())

    def try_get_reserved(self, wand_id: str) -> str | None:
        return self._reserved_by_id.get(wand_id.upper())

    def try_get_known(self, wand_id: str) -> str | None:
        wand_id = wand_id.upper()
        return self._active_by_id.get(wand_id) or self._reserved_by_id.get(wand_id)
